...
Esse foi meu primeiro projeto na Trybe. Pude trabalhar conceitos iniciais de `HTML Semântico` e `CSS`. É uma pagina sobre lições aprendidas e meu desenvolvimento dentro da Trybe.
---
...
```javascript
  mkdir projetos-joao-gabriel
```

2. Entre no diretório que acabou de criar e depois clone o projeto:
```javascript
  cd projetos-joao-gabriel
  git clone git@github.com:joaogrs/leassonsLearned.git
```
